  ...
  return (
    <div className="flex-1 bg-white rounded-lg p-4 border border-brand-purple/10 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        <span className="flex-shrink-0 w-6 h-6 inline-flex items-center justify-center text-brand-purple">{icon}</span>
...
const icons = {
  earned: (
    <svg width="24" height="24" className="w-full h-full flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
